...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const systemPrompt = `Você é um professor especialista em concursos públicos brasileiros, especificamente no concurso RM2 da Marinha do Brasil para Oficiais Temporários, cuja prova é exclusivamente de Língua Portuguesa. Responda SOMENTE com JSON válido, sem texto adicional, sem markdown.`;
